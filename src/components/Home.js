...
function Home() {
    ...
    function shift(t){
        ...
        let index = document.querySelector('.grid-box.active').id.split('_')[1]
        let curr_index = parseInt(index)
        ...
        <div className="content">
            ...
            <div className="grid-main">
                {HomeList.map((homeItem, key) => {
                    return (
                        <div key={key} className={key === 0? 'grid-box active' : 'grid-box'} id={'box_'+homeItem.id+''}>
